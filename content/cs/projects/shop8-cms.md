...
Na projektu jsem pracoval s kolegy kteří mě hodně naučily o tom jak správně by měl takový systém vypadat a byl součástí teamu s kolegy na backendu tak i frontendu. Administrace zahrnuje několik modulů pro správu eshopu jako je uživatelský účet, dopravy, platby, pobočky, slevové kupóny a jiné. V obsahové části lze mimo jiné i spravovat kategorie, vlastní eventy ale nejhlavnějším jsou produkty kde uživatel může využít správů verzí tedy historie produktu, varianty produkty nebo jazykové mutace a mnoho dalšího.
...
- **React Hook Forms**
- **React Router**
- **TinyMCE, Chonky, React DND, React Hot Toast, React Player, React Modal Promise**
- **antd - Tree**
- **Eslint, Prettier**
- **Typescript**
- **Webpack**
...
Úspěšně implementované CMS řešení, které umožňuje středně velkým firmám efektivně spravovat své online obchody a růst spolu s jejich byznysem.
::
